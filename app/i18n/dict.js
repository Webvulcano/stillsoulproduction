    ...
    services: {
      ...
      items: [
        ...
        { title: "Events & functions" },
        {
          ...
          details:
            "(editor, assistant director, line producer, gaffer, set designer, art director, set dresser)",
        },
        { title: "Documentary & fiction filmmaking" },
      ],
    },
    contact: {
      label: "— Get a Quote —",
